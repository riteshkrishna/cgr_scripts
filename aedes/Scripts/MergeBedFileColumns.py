...
if __name__=="__main__":
    bed_file_dir = "/pub9/ritesh/Aedes_Aegypti/BowtieMappings_single/contigs_mergedBams"
    mergedFile = "/pub9/ritesh/Aedes_Aegypti/BowtieMappings_single/contigs_mergedBams/coverage_allBed.txt"
