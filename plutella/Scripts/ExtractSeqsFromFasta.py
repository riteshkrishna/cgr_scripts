...
if __name__ == "__main__":
    ...
    fastaFile = '/pub9/ritesh/Plutella/sequenceStorage/scf.fasta'
    # File containing FASTA accessions
    accessionFile = '/pub9/ritesh/Plutella/Analysis/scaffolds/Plut_outlier_log2_1.5(lb)_2.5(ub).txt'
    # Output FASTA file
    out_acc_fasta = '/pub9/ritesh/Plutella/Analysis/scaffolds/Plut_outlier_log2_1.5(lb)_2.5(ub).fasta'
