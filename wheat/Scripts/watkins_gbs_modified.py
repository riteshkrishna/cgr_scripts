...
os.system("java -jar /pub6/kate/lamotrigine/Trimmed/virusfinder/VirusFinder2.0/bin/CreateSequenceDictionary.jar R= {0} O= {1}.dict".format(args.reference, args.reference.rstrip('.fa')))
